...
export const COURSES: CourseDef[] = [
  ...
  // ── Tier 1: requires basics ────────────────────────────────────────────────
  {
    ...
    cost: 100, timeCost: 20, eduPoints: 0.5, prerequisites: ['basics'],
  },
  {
    id: 'intro_tech',
  ...
  },
  {
    ...
    cost: 80, timeCost: 15, eduPoints: 0.3, prerequisites: ['basics'],
  },
  ...
  // ── Tier 3: advanced ──────────────────────────────────────────────────────
  {
    ...
    cost: 250, timeCost: 30, eduPoints: 1.0, prerequisites: ['accounting'],
  },
  {
    id: 'software_eng',
    title: 'Software Engineering',
    description: 'Systems design, algorithms, and full-stack development.',
    cost: 250, timeCost: 30, eduPoints: 1.0, prerequisites: ['web_dev'],
  },
  {
    id: 'med_tech',
    title: 'Medical Technology',
    description: 'Diagnostic equipment, clinical procedures, and patient management.',
    cost: 200, timeCost: 25, eduPoints: 0.9, prerequisites: ['first_aid'],
  },
  {
    id: 'nursing',
