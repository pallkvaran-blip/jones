...
export const DEALERSHIP_WORK_EVENTS: WorkEvent[] = [
  {
    id: 'dealership_test_drive',
    title: 'The Endless Test Drive',
    description: "A customer took a test drive forty minutes ago. They were supposed to be back in fifteen. Your phone shows the car is currently parked at a diner across town.",
    choices: [
      { label: 'Call them and ask them to return — professionally', delta: { money: 200, morale: 10 }, logMsg: "They apologised and returned with coffee for the whole floor. Bought the car." },
      { label: 'Send a colleague to collect the vehicle', delta: { money: 100, energy: -10 }, logMsg: "The car came back. The customer followed shortly after, slightly embarrassed." },
      { label: "Wait calmly — it's a good sign they like it", delta: { morale: 15, money: 300 }, logMsg: "They returned in their own time. The diner apparently sealed the deal. Full asking price." },
    ],
  },
  {
    id: 'dealership_trade_in',
    title: 'The Trade-In Problem',
    description: "A customer's trade-in was valued at $4,000. You've just discovered it has a mystery clunk above 60mph and the air conditioning only works in reverse.",
    choices: [
      { label: 'Revise the offer down and explain why', delta: { money: 200, morale: 5 }, logMsg: "They were frustrated but accepted a revised $2,200 offer. Sale still closed." },
      { label: 'Honour the original offer to keep goodwill', delta: { money: -150, morale: 20 }, logMsg: "You honoured it. The clunk cost $600 to fix. They referred two friends." },
      { label: "Flag it as a 'project car' and price accordingly", delta: { morale: 20, money: 100 }, logMsg: "The project car listing sold in three days. Someone's weekend sorted." },
    ],
  },
  {
    id: 'dealership_financing_collapse',
    title: 'Financing Fell Through',
    description: "The customer's loan was approved this morning. It has just been rejected an hour before collection. They are already on their way in.",
    choices: [
      { label: 'Call before they arrive and explain clearly', delta: { money: 100, morale: 10 }, logMsg: "They appreciated the heads up. You rebooked them for a lower-spec model that did clear." },
      { label: 'Explore alternative financing options urgently', delta: { money: 300, morale: 15 }, logMsg: "You found a credit union that worked. Paperwork took two hours. Deal closed." },
      { label: 'Let them arrive, then work through it together', delta: { money: 100, morale: 15 }, logMsg: "The meeting was tense but productive. They came back the following week, financing sorted." },
    ],
  },
  {
    id: 'dealership_wrong_colour',
    title: 'Wrong Colour',
    description: "A car has been collected and returned within the hour. The customer ordered Midnight Blue. What arrived is Sapphire Metallic. These are, apparently, completely different colours.",
    choices: [
      { label: 'Apologise fully and arrange a swap immediately', delta: { money: -80, morale: 20 }, logMsg: "The correct car arrived in four days. They left a glowing review about how it was handled." },
      { label: 'Point out they are extremely similar in all lighting', delta: { money: 100, morale: 5 }, logMsg: "They disagreed. Loudly. But calmed down. They kept the car." },
      { label: "Arrange a complimentary upgrade while sourcing the right one", delta: { money: -150, morale: 25 }, logMsg: "They drove a higher model for a week. It complicated the swap. They bought the upgrade instead." },
    ],
  },
  {
    id: 'dealership_celebrity',
    title: 'Famous Customer',
    description: "You are fairly sure the person in the sportscar section is a minor celebrity. They are wearing large sunglasses indoors and have parked a very conspicuous car outside.",
    choices: [
      { label: 'Treat them exactly like anyone else', delta: { money: 300, morale: 10 }, logMsg: "They bought two cars and left a generous commission. They come back for servicing." },
      { label: 'Offer a private walkthrough away from the floor', delta: { money: 200, morale: 20 }, logMsg: "They appreciated the discretion. Their assistant mentioned a fleet order." },
      { label: "Ask for a photo immediately", delta: { fired: true, morale: 15 }, logMsg: "They left without buying. You were let go that afternoon." },
    ],
  },
  {
    id: 'dealership_demo_car',
    title: 'Demo Car Incident',
    description: "A staff member has returned the demo vehicle with a fresh dent that nobody is claiming responsibility for. A customer is booked for a test drive in forty minutes.",
    choices: [
      { label: 'Get a rapid repair estimate and rebook the customer', delta: { money: 100, morale: 10 }, logMsg: "Customer rebooked graciously. Repair cost $180. Source of dent remains unknown." },
      { label: 'Use a different vehicle for the test drive', delta: { morale: 20, money: 200 }, logMsg: "Swapped seamlessly. Customer had no idea. Bought the car." },
      { label: 'Investigate the dent before doing anything else', delta: { money: -80, morale: 10 }, logMsg: "Forty minutes later, culprit identified. Test drive rebooked. Justice was served, sort of." },
    ],
  },
  {
    id: 'dealership_price_negotiation',
    title: 'The Negotiator',
    description: "A customer has been in your office for ninety minutes negotiating a price. They have a printed sheet of competitor prices, a calculator, and what appears to be a packed lunch.",
    choices: [
      { label: "Hold the line — the price is the price", delta: { money: 300, morale: 5 }, logMsg: "They eventually conceded. You settled $200 above their target. Both satisfied." },
      { label: 'Offer extras instead of a discount', delta: { money: 200, morale: 15 }, logMsg: "Floor mats, extended warranty, and a full tank. They accepted. Car sold at list price." },
      { label: 'Match one competitor price and close it', delta: { money: 100, morale: 20 }, logMsg: "You matched $400 off. They shook on it immediately. The packed lunch was never opened." },
    ],
  },
  {
    id: 'dealership_lost_keys',
    title: 'The Missing Keys',
    description: "The keys to a customer's newly purchased vehicle cannot be found. Collection is in an hour. The spare set is in a lockbox that requires a code nobody currently remembers.",
    choices: [
      { label: 'Call a locksmith immediately', delta: { money: -100, morale: 10 }, logMsg: "Locksmith arrived in time. Customer never knew. Keys emerged from a jacket pocket later." },
      { label: 'Launch a full floor-wide key search', delta: { energy: -10, morale: 20, money: 200 }, logMsg: "Keys found in a teacup. Nobody admits to putting them there. All present treated it as a win." },
      { label: 'Contact the manufacturer for an emergency cut', delta: { money: -150, morale: 15 }, logMsg: "New keys arrived next day. Customer collected then. Grateful for the transparency." },
    ],
  },
  {
    id: 'dealership_warranty_dispute',
    title: 'Warranty Dispute',
    description: "A customer is insisting the warranty covers a dent that, by their account, 'appeared by itself overnight' in the exact shape of a bollard.",
    choices: [
      { label: 'Explain the warranty terms clearly and firmly', delta: { money: 200, morale: 5 }, logMsg: "They accepted after reading the policy. You offered a discounted repair as goodwill." },
      { label: 'Escalate to the manufacturer warranty team', delta: { money: 100, morale: 10 }, logMsg: "The manufacturer agreed with you. The customer left with a 20% repair discount and mild dignity." },
      { label: "Cover it this once to protect the relationship", delta: { money: -150, morale: 20 }, logMsg: "Repair done, no charge. They referred three friends. The bollard was never mentioned again." },
    ],
  },
  {
    id: 'dealership_mystery_smell',
    title: 'The Smell',
    description: "A brand-new car has arrived from the transport carrier with an unexplained smell. It is somewhere between fast food and something older. The customer is coming tomorrow.",
    choices: [
      { label: 'Deep clean it tonight — problem solved', delta: { money: 100, energy: -15, morale: 10 }, logMsg: "Three hours and some ozone treatment later, no trace remained. Customer noticed nothing." },
      { label: 'Delay delivery and investigate the source', delta: { money: -80, morale: 15 }, logMsg: "A vintage sandwich had wedged itself into the spare tyre well. Carrier reimbursed the clean." },
      { label: "Describe it as 'new car smell, enhanced edition'", delta: { morale: 5, money: -150 }, logMsg: "Customer asked about it. You held the line. They returned the car. Very complicated paperwork." },
    ],
  },
  {
    id: 'dealership_fleet_deal',
    title: 'The Fleet Opportunity',
    description: "A local company wants to order twelve vehicles for their sales team. The deal is worth more than your last three months combined. Their rep wants a decision today.",
    choices: [
      { label: 'Confirm the deal immediately — this is the one', delta: { money: 400, morale: 20 }, logMsg: "Deal signed. Fleet delivered in two weeks. The commission was extremely pleasant." },
      { label: 'Review terms carefully before signing', delta: { money: 300, morale: 15 }, logMsg: "Took four hours. Found one clause worth changing. They accepted. Still a very large commission." },
      { label: 'Push for a slightly better margin', delta: { money: 200, morale: 10 }, logMsg: "They agreed to $150 more per unit. Not what you asked for. Better than nothing." },
    ],
  },
  {
    id: 'dealership_minor_crash',
    title: 'The Test Drive Return',
    description: "A customer has returned from a test drive very slowly. There is a small, very fresh scrape on the rear bumper. They are smiling with enormous effort.",
    choices: [
      { label: 'Ask them directly and professionally what happened', delta: { money: 200, morale: 10 }, logMsg: "They admitted contact with a 'stationary obstacle.' Insurance sorted it. They still bought the car." },
      { label: 'Say nothing and process the sale as normal', delta: { money: 300, morale: -10 }, logMsg: "You noticed, they knew you noticed. The sale closed. The scrape was discovered later." },
      { label: 'Refuse the sale until the incident is documented', delta: { money: -80, morale: 20 }, logMsg: "They respected the process. Insurance handled everything. They came back and bought a different model." },
    ],
  },
]
...
const LOCATION_WORK_EVENTS: Partial<Record<LocationId, WorkEvent[]>> = {
  ...
  dealership: DEALERSHIP_WORK_EVENTS,
}
