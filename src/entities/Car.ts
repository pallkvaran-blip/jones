...
/** Returns world-space waypoints the car should follow from one building to another. */
export function buildRoute(
  ...
  pts.push({ x: to.cx, y: to.cy })       // park at doorstep
...
export class Car {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number) {
    ...
    this.sprite = scene.add.image(0, 0, 'car')
