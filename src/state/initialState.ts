...
export function createInitialState(name: string, difficulty: Difficulty): GameState {
  const difficultySettings = {
    easy:   { money: 500, maxWeeks: 30, goals: { targetWealth: 5000,  targetEducation: 1, targetCareerRank: 1, targetHappiness: 60 } },
    normal: { money: 300, maxWeeks: 24, goals: { targetWealth: 10000, targetEducation: 2, targetCareerRank: 1, targetHappiness: 70 } },
    hard:   { money: 150, maxWeeks: 20, goals: { targetWealth: 25000, targetEducation: 3, targetCareerRank: 1, targetHappiness: 80 } },
  };
